-- Add exclude_fields column to noise_filter_rules table (PostgreSQL)
...
COMMENT ON COLUMN noise_filter_rules.exclude_fields IS 'Comma-separated list of field names to exclude from pattern matching (e.g., agent.url,url,subdomain)';
