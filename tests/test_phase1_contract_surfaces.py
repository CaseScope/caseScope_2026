...
class Phase1ContractSurfacesTestCase(unittest.TestCase):
    ...
    def test_case_analyzer_uses_snapshot_and_pipeline_wrappers(self):
        ...
        self.assertIn('materialize_pattern_package,', source)
        ...
        self.assertIn('materialized = materialize_pattern_package(', source)
        self.assertIn("if materialized['should_emit_finding']:", source)
