...
class GraphProjectionState(db.Model):
    ...
    projection_version = db.Column(db.String(40), nullable=False, default='graph_events_v2_windowed')
    ...
    current_window_start_utc = db.Column(db.DateTime, nullable=True)
    current_window_end_utc = db.Column(db.DateTime, nullable=True)
    last_completed_window_end_utc = db.Column(db.DateTime, nullable=True)
    windows_completed = db.Column(db.BigInteger, nullable=False, default=0)
