...
def generate_keypair():
    ...
    print()
    print("-" * 60)
    print("PUBLIC KEY (configure in CaseScope UI):")
    print("-" * 60)
    print(public_b64)
    print()
    print("-" * 60)
    print("NEXT STEPS:")
    print("-" * 60)
    print("1. Keep license_private_key.pem SECURE on your activation server")
    print("2. On each CaseScope instance, go to: Activation page")
    print("3. Paste the public key above into 'License Verification Public Key' field")
    print("4. Use generate_license.py to create signed licenses for customers")
    print()
