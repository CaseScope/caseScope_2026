...
CREDENTIAL_ACCESS_PATTERNS = {
    ...
    'lsass_memory_dump': {
        ...
        'required_check_ids': [
            ...
            'lsass_dump_file',
            'lsass_suspicious_process',
            'lsass_sysmon_technique_tag',
            'lsass_calltrace_short'
        ],
        'required_pass_count': 1,
        'emit_threshold_mode': 'score_and_required',
        'allow_anchor_only_emit': False,
...
def _materialize_pattern_config(pattern_id: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    materialized = {
        **copy.deepcopy(config),
        ...
        'lateral_movement': bool(config.get('lateral_movement', False)),
