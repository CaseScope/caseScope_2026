...
CLAIM_SUPPORT_CATEGORIES: Dict[str, Set[str]] = {
    "known-good": {"known_good", "noise"},
    "known good": {"known_good", "noise"},
    "allowlisted": {"known_good", "noise"},
    "whitelisted": {"known_good", "noise"},
    "approved admin": {"known_good", "noise", "user_role"},
    "expected admin": {"known_good", "noise", "user_role"},
    "known administrative workflow": {"known_good", "noise"},
    "noise": {"noise"},
    "noise rule": {"noise"},
    "known noise": {"noise"},
    "rmm": {"known_good", "noise"},
