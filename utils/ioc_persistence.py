...
def _build_source_contribution(
    ...
    *,
    ...
    return {
        ...
        "candidate_id": ioc_entry.get("candidate_id"),
        "raw_value": ioc_entry.get("raw_value"),
        "normalized_value": ioc_entry.get("normalized_value"),
        "evidence": ioc_entry.get("evidence"),
        "evidence_origin": ioc_entry.get("evidence_origin"),
        "extraction_method": ioc_entry.get("extraction_method"),
        "semantic_route": ioc_entry.get("semantic_route"),
        "evidence_source_type": ioc_entry.get("evidence_source_type"),
        "evidence_source_product": ioc_entry.get("evidence_source_product"),
