    ...
    def _build_evidence_adjudication_prompt(
        *,
        ...
        prompt = (
            ...
            "threat-intel status, noise/known-good status, allowlist/whitelist status, "
            "or administrative workflow unless supported by a referenced known context fact.\n"
            ...
            "- Citing context:known_good or context:noise with status unknown does not prove "
            "known-good, noise, allowlisted, approved admin, expected admin, RMM, or benign administrative "
            "workflow.\n"
            ...
            "- A known context:noise fact means the event matched an explicit noise/known-good "
            "rule and may have a benign explanation. It is mitigating context only; it is not "
            "proof that the activity is benign, and it must not override strong deterministic "
            "evidence by itself.\n"
            "\nTRUSTED-CONTEXT WORDING CONTROL:\n"
            "- Avoid using trusted-context phrases unless they are supported by a referenced "
            "known context fact.\n"
            "- Do not say \"known-good,\" \"noise,\" \"noise rule,\" \"allowlisted,\" "
            "\"approved admin,\" \"expected admin,\" \"known administrative workflow,\" or "
            "\"benign administrative workflow\" unless a referenced known noise, known_good, "
            "or user_role context fact supports it.\n"
            ...
            "- If using context:noise, describe it as a possible benign explanation or "
